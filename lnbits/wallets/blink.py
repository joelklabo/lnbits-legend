...
class BlinkWallet(Wallet):
    ...
    async def pay_invoice(
        self, bolt11_or_bolt12_invoice: str, fee_limit_msat: int
    ) -> PaymentResponse:
        ...
        payment_variables = {
            "input": {
                "paymentRequest": bolt11_or_bolt12_invoice,
        ...
        try:
            ...
            checking_id = bolt11_or_bolt12.decode(bolt11_or_bolt12_invoice).payment_hash
            ...
            logger.info(f"Failed to pay invoice {bolt11_or_bolt12_invoice}")
            logger.warning(exc)
            return PaymentResponse(
