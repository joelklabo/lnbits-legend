...
@payment_router.post(
    ...
    description="""
        This endpoint can be used both to generate and pay a BOLT12 invoice.
        ...
        field to supply the BOLT12 invoice to be paid.
    """,
    status_code=HTTPStatus.CREATED,
    responses={
        400: {"description": "Invalid BOLT12 string or missing fields."},
